...
public class NewController {
    ...
    // Rota da página
    @GetMapping("/novo")
    public String newPad(@CookieValue(value = "owner_uid", required = false) String ownerUid, Model model) {

        if (ownerUid == null || ownerUid.isEmpty()) {
            return "redirect:/"; // Redireciona para a raiz se o cookie não existir ou estiver vazio
        }
